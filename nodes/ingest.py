...
#encapsulate it into a node for LangGraph
...
#wrap the ingestion code into a function
def ingest_node(state:GraphState):
    ...
    return {
        "results":[f"Split the docs into {len(all_splits)} sub-documents",f"IDs: {document_ids[:3]}"]
    }
